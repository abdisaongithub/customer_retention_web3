...
const ParticipatingcampaignsListItem = (props) => {
    const [createParticipatingcampaign] = useCreateParticipatingcampaignMutation()
    const {
    ...
    const [destroyParticipatingcampaign] = useDestroyParticipatingcampaignMutation()
    ...
    const onDeleteClicked = async () => {
        ...
        toast.promise(destroyParticipatingcampaign({
            id: props.id
        }).unwrap(), {
        ...
        <tr key={props.react_unique_identifier_key}>
                ...
                <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                    <div className="space-x-1 flex">
                        <Link to={`/participatingcampaigns/${props.id}`}
            ...
            <ModalBasic title={"Delete Participatingcampaign"} id={props.id} modalOpen={deleteModal} setModalOpen={(e) => {
                setDeleteModal(false)
            }} children={
                <div className="border-t border-slate-200">
                    <div className="pb-3 px-3 pt-3">
                        <span className={`font-bold`}>{props.status }</span> will be deleted! Are you sure to delete this
                        ...
                        <div className="flex mt-5 mx-auto">
                            ...
                            >
                                <span className="hidden xs:block ml-1">Delete Participatingcampaign</span>
                            </button>
                        </div>
                    </div>
                </div>
...
export default ParticipatingcampaignsListItem