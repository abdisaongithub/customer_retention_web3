...
import ParticipatingcampaignsListItem from "./ParticipatingcampaignsListItem"
import {
...
const ParticipatingcampaignsList = () => {
    const {
    ...
    if (isError) {
        toast.error("Could not fetch the Participatingcampaign", {
        ...
        <>
            ...
            <div className="bg-white shadow-lg rounded-sm border border-slate-200 relative">
                <header className="px-5 py-4">
                    <h2 className="font-semibold text-slate-800">Participatingcampaigns - <span
                        ...
                        <table className="table-auto w-full">
                            ...
                            <tbody className="text-sm divide-y divide-slate-200">
                            {
                              data['rows']?.map(listElement => {
                                    return (
                                        <ParticipatingcampaignsListItem
                                            key={listElement.id}
...
export default ParticipatingcampaignsList