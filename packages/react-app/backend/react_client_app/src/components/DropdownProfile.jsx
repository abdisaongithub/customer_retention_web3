...
import {useSignOutMutation} from "../pages/authentication/authenticationSlice";
        ...
        {isSuccess && <div className="relative inline-flex">
          ...
          >
            ...
            <div className="flex items-center truncate">
              <span className="truncate ml-2 text-sm font-medium group-hover:text-slate-800">James Oliver</span>
              {/*TODO: make this username dynamic*/}
